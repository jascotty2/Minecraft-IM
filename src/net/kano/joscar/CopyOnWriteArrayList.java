 ...
 * 10Aug2011 jascotty2		made to generic class
*/
 ...
 **/
public class CopyOnWriteArrayList<E extends Object> implements List<E>, Cloneable,
     ...
     **/
    protected synchronized E[] array() { return array_; }
     ...
     **/
	@SuppressWarnings("unchecked")
    public final synchronized void copyIn(Object[] toCopyIn, int first, int n) {
    ...
    public E[] toArray() {
        E[] elementData = array();
		@SuppressWarnings("unchecked")
        E[] result = (E[]) new Object[elementData.length];
    ...
    public synchronized int addAllAbsent(Collection<E> c) {
        int numNew = c.size();
    ...
    protected static class COWIterator<E extends Object> implements ListIterator<E> {
        ...
        protected COWIterator(E[] elementArray, int initialCursor) {
            array = elementArray;
    ...
    protected static class COWSubList<E extends Object> extends AbstractList<E> {
        ...
        */
        ...
        protected COWSubList(CopyOnWriteArrayList<E> list,
        ...
        public Iterator<E> iterator() {
            synchronized (l) {
                checkForComodification();
                return new COWSubListIterator<E>(0);
            }
        }
		...
		public ListIterator<E> listIterator(final int index) {
            synchronized (l) {
                ...
                return new COWSubListIterator<E>(index);
            }
        }

        protected class COWSubListIterator<E> implements ListIterator<E> {
            ...
            protected COWSubListIterator(int index) {
                this.index = index;
                i = (ListIterator<E>) l.listIterator(index + offset);
            }
